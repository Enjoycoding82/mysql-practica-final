...
CREATE TABLE `empleats` (
  ...
  UNIQUE KEY `id_empleat_UNIQUE` (`id_empleat`)
...
INSERT INTO `empleats` VALUES (1,'Fernando González'),(2,'Yolanda Boronat'),(3,'Gemma Triguero'),(4,'Anna Corniel'),(5,'Albert Pons');
